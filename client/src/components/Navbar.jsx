            ...
            <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-purple-500">
                <div className="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-3.5">
                    ...
                    <div className="flex md:order-2">
                        {estalogeado  ? (
                            <>
                                <h3 className={`text-white mt-1.5  w-20  md:mr-1 `}>{user.username}</h3>
                                <Link to="/profile" className={`w-8 mt-1  md:ml-1`}>
                    ...
                    <div className={`items-center justify-between ${isMenuOpen ? '' : 'hidden'
                        ...
                        <ul className="flex flex-col p-4 md:p-0 mt-4  border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            {estalogeado && user.rol == 'taxonomo' || estalogeado && user.rol == 'dig' ? (
                                <li >
                                    <Link to="/registrotaxonomico" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 md:dark:hover:text-green-400 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700" >Registro Taxonómico</Link>                         </li>) : estalogeado && user.rol == 'admin' ? (
                                    <li>
                                        <Link to="/adminmodulos" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent  md:p-0 md:dark:hover:text-green-400 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700" >Modulos Administrador</Link>
                                    </li>
                                ) :
                                estalogeado && user.rol == 'dig' ? (<li>
                                    <Link to="#" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparentmd:dark:hover:text-green-400 md:p-0 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700" >Modulos Digitador</Link>                           </li>) : 
                                estalogeado && user.rol == 'usuario' ? (<li>
                                    <Link to="#" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:dark:hover:text-green-400 md:p-0  dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700" >Galería de Especies</Link>                             </li>):( <li>
                                    <Link to="/registrotaxonomico" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent  md:p-0 md:dark:hover:text-green-400 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700" >Registro Taxonómico</Link>                            </li>)}
                            <li>
                                <Link to="/clasificacion" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:dark:hover:text-green-400 md:p-0 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Clasificación</Link>                       </li>
                            <li>
                                <Link to="/acerca" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:dark:hover:text-green-400  md:p-0  dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Acerca de</Link>
                            </li>
                        </ul>
